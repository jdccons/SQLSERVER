...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[vw_CommissionCheckRegister]
as
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Transactions from QuickBooks showing checks written and payments made to agents.', 'SCHEMA', N'dbo', 'VIEW', N'vw_CommissionCheckRegister', NULL, NULL
GO
